...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while (Continue)
        {
            boolean despacito = false;
            for (int i = 0; i < language.length; i++)
            {
                System.out.println("\u001B[34m" + language[i][0] +"\u001B[0m");
            }
            System.out.println("\u001B[34mPlease select a language from the provided list:\u001B[0m");
            boolean valid = false;
            String input = "";
            while (!valid)
            {
                ...
                for (int i = 0; i < language.length; i++)
                {
                    if (input.equalsIgnoreCase(language[i][0]))
                    {
                        valid = true;
                        input = language[i][1];
                        despacito = false;
                    ...
                    if (input.equalsIgnoreCase("despacito"))
                    {
                        despacito = true;
                        break;
                    }
                ...
                {
                    new Frame();
                    System.out.println("No seriously, what language?");
                }
            }
